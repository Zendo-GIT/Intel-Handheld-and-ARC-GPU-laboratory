#!/usr/bin/env python3
"""Swap one confirmed water instance to Kena's cooked opaque water parent."""
...
NEW_PARENT_NAME = "M_Water_UIWS_Opaque"
OLD_PARENT_PATH = "/Game/Mochi/MaterialLibrary/Water/UIWS/M_Water_UIWS"
NEW_PARENT_PATH = "/Game/Mochi/MaterialLibrary/Water/UIWS/M_Water_UIWS_Opaque"
        ...
        json.dumps(
            {
                ...
                "purpose": "Separate the translucent water pass from common lighting",
            },
            ensure_ascii=False,
            indent=2,
        )
