#!/usr/bin/env python3
"""Disable refraction distortion on the confirmed Forest Path water instance."""
...
PARAMETER = "RefractionScale"
EXPECTED_GUID = "{990A8911-4123-856A-AB47-A3B8879516AC}"
EXPECTED_VALUE = 1.5
TARGET_VALUE = 0.0
        ...
        json.dumps(
            {
                ...
                "purpose": "Isolate the water distortion/refraction path",
            },
            ensure_ascii=False,
            indent=2,
        )
