#!/usr/bin/env python3
"""Disable only the animated foam opacity on the confirmed Forest Path water."""
...
EXPECTED_GUID = "{CB569CB5-4FF6-722B-35EE-E89BB3D5DF72}"
EXPECTED_VALUE = 0.2
TARGET_VALUE = 0.0
        ...
        json.dumps(
            {
                ...
                "purpose": "Isolate the separately animated foam layer",
            },
            ensure_ascii=False,
            indent=2,
        )
