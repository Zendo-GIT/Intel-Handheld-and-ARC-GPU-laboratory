...
floor to 120 Hz. It stops 500 ms after input and has no active animation timer
at idle. Hidden cursors suppress animation; Xbox Full Screen Experience remains supported.

The 48-144 and 30-144 profiles have been removed. Version 2.1.0 cannot install
...
6. Restart and run CHECK_STATUS.bat.
