@echo off
setlocal
title ClawLab UNSTABLE EXPERIMENTAL 30-180 Hz VRR and display overclock
...
echo.
echo ===============================================================================
echo   UNTESTED 30 HZ FLOOR PLUS DISPLAY OVERCLOCK - EXTREME RISK
echo ===============================================================================
echo Profile: 30-180 Hz - UNSTABLE EXPERIMENTAL - NOT VALIDATED BY CLAWLAB
...
powershell.exe -NoLogo -NoProfile -ExecutionPolicy Bypass -File "%CLAWLAB_SCRIPTS%MSI-Claw-VRR-Fix.ps1" -Action Install30_180
if errorlevel 1 goto :failed
echo The guarded 30-180 Hz trial is scheduled for the next Windows sign-in.
