@echo off
setlocal
title ClawLab UNSTABLE EXPERIMENTAL 30-165 Hz VRR and display overclock
...
echo ===============================================================================
echo Profile: 30-165 Hz - UNSTABLE EXPERIMENTAL - NOT VALIDATED BY CLAWLAB
echo 165 Hz may work only on some units due to the panel silicon lottery.
...
powershell.exe -NoLogo -NoProfile -ExecutionPolicy Bypass -File "%CLAWLAB_SCRIPTS%MSI-Claw-VRR-Fix.ps1" -Action Install30_165
if errorlevel 1 goto :failed
echo The guarded 30-165 Hz trial is scheduled for the next Windows sign-in.
