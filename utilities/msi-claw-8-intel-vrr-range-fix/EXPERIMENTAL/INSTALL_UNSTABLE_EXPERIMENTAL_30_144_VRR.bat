@echo off
setlocal
title ClawLab UNSTABLE EXPERIMENTAL 30-144 Hz VRR and display overclock
...
echo.
echo ===============================================================================
echo   UNSTABLE EXPERIMENT: 30 HZ FLOOR PLUS DISPLAY OVERCLOCK - HIGH RISK
echo ===============================================================================
echo Profile: 30-144 Hz - UNSTABLE EXPERIMENTAL - NOT VALIDATED BY CLAWLAB
echo It combines the unofficial 30 Hz floor with a 144 Hz panel overclock.
echo Results depend on the individual panel silicon lottery. Not MSI-certified.
echo.
...
powershell.exe -NoLogo -NoProfile -ExecutionPolicy Bypass -File "%CLAWLAB_SCRIPTS%MSI-Claw-VRR-Fix.ps1" -Action Install30_144
if errorlevel 1 goto :failed
echo The guarded 30-144 Hz trial is scheduled for the next Windows sign-in.
