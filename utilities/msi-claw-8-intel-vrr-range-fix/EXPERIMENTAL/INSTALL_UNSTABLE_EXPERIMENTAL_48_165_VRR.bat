@echo off
setlocal
title ClawLab UNSTABLE EXPERIMENTAL 48-165 Hz display overclock
...
echo.
echo ===============================================================================
echo   UNTESTED DISPLAY OVERCLOCK - OUTSIDE MSI SPECIFICATIONS - HIGH RISK
echo ===============================================================================
echo Profile: 48-165 Hz - UNSTABLE EXPERIMENTAL - NOT VALIDATED BY CLAWLAB
echo 165 Hz may be attainable only on some units due to the panel silicon lottery.
...
echo Windows asks whether 165 Hz was reached only after safe 120 Hz is restored.
...
powershell.exe -NoLogo -NoProfile -ExecutionPolicy Bypass -File "%CLAWLAB_SCRIPTS%MSI-Claw-VRR-Fix.ps1" -Action Install48_165
if errorlevel 1 goto :failed
echo The guarded 48-165 Hz trial is scheduled for the next Windows sign-in.
