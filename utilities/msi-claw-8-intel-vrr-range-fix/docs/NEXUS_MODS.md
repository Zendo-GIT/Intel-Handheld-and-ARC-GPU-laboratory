...
Default 30-120 Hz MSI Claw Intel VRR profile with the community-validated Intel
LFC x2 correction, plus the official Intel/MSI 48-120 Hz profile. Includes
...
The 30-120 LFC x2 correction uses a readable Windows D3DKMT request to Intel's
driver-private VRR interface. It saves and disables both Intel low/high-FPS
solutions as one tested combination. This is not a public Intel API. It performs
no game-process operation and installs no continuous watcher. LFC below 30 FPS
...
If a graphics-driver update replaces Intel Graphics Software, version 2.0.0
...
should emphasize the default validated 30-120 + LFC correction and retain
48-120 as the official Intel/MSI profile. Label both 144 installers prominently
as guarded panel-overclock trials. State that 30-144 visibly flickered on the
reference panel and that VRR at 144 Hz is not guaranteed.
